...
- l'elaborazione di piani di gestione integrata a medio e a lungo termine dei boschi oggetto di tutela ed in modo da ottimizzarne le funzioni dirette (protezione del terreno, della biodiversità, fornitura di legname ed altri prodotti forestali, ecc.) ed indirette (valori estetici, culturali, ecc.) ;
...
Le tecniche adottate hanno consistito: nella stabilizzazione meccanica delle dune alte da 3 -6 metri a 30 metri) mediante la creazione di barriere artificiali (superficie trattata 1.163 ha);
nella fissazione delle dune con il rimboschimento delle dune (superficie 1.413 ha) o la semina di specie vegetali autoctone arboree, arbustive o erbacee; protezione delle aree oggetto degli interventi.
...
L’agricoltura itinerante, l’uso intensivo delle terre marginali nei bacini imbriferi hanno causato danni ambientali talvolta irreparabili. Le foreste naturali sono state quasi totalmente distrutte ( nel 1940 coprivano il 40% del territorio ed attualmente solo l’1%).
Le conseguenze della deforestazione sono: la perdita della fertilità del terreno, l’insabbiamento delle aree agricole, l’accelerazione del fenomeno della desertificazione, il verificarsi di inondazioni e di fenomeni erosivi diffusi.
Il progetto ha finanziato l’assistenza tecnica al Centro di formazione di Limbè per il personale tecnico in materia di conservazione dei suoli.
STR
...
Gli interventi di ricostituzione delle risorse forestali sono una componente importante della politica forestale; sono stati infatti realizzati programmi nazionali di rimboschimento su vasta scala come “The Green Great Wall “che è stato attuato su una superficie di 3.470.000 Km2, è esteso per 7.000 Km ed interessa 12 province o come “Il Great Plans” , nell’ambito del quale sono stati rimboschiti 100 milioni di ha con tecniche agro-forestali . I rimboschimenti prevedono l’impiego di specie a rapido accrescimento o multi-uso, piantagioni miste di varie specie in associazione con colture agricole con una componente di protezione del suolo e dell’ecosistema, turni brevi, utilizzazioni intensive.
L’obiettivo principale del progetto era il rimboschimento di un’area di 5.000 ha ,nella provincia di Jilin, soggetta ad erosione eolica ed idrica per proteggere le aree coltivate e ricostituire le risorse forestali per la produzione di legname.
STR
